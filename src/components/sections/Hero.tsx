...
export function Hero() {
  return (
    ...
    >
      <Image
        src="/images/hero.jpg"
        alt="BP Creatives professional presenting in a modern Nairobi office"
        fill
        priority
      ...
      <div className="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-bp-green/30 to-transparent" />
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_auto]">
          <div className="max-w-2xl">
            ...
            >
              ...
              <br />
              We build your{" "}
              <em className="text-bp-gold not-italic">
                legacy.
              </em>
            </motion.h1>
            <motion.p
            ...
            >
              ...
              brands in Nairobi shape perception, earn trust, and grow with
              influence.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              {heroProof.map((item) => (
                <span
                  key={item}
                  className="border border-white/15 bg-bp-green/35 px-4 py-2 text-[11px] font-medium uppercase tracking-[0.18em] text-white/78 backdrop-blur"
                >
                  {item}
                </span>
              ))}
          ...
          >
            <span className="h-28 w-px bg-white/20" />
            <div>
