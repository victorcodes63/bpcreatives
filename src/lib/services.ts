...
export const SERVICES: readonly Service[] = [
  {
    ...
    overview: [
      ...
      "From Nairobi to national and international outlets, we craft pitches, press materials, and spokesperson readiness that align with your business goals, not vanity coverage for its own sake.",
  ...
  },
  {
    ...
    overview: [
      ...
      "For organisations scaling across Kenya or refining after growth, we bring structure to instinct, giving your teams a shared language for decisions, campaigns, and partnerships.",
    ],
    deliverables: [
    ...
    icon: "message-square",
    metaDescription:
      "Brand strategy and positioning for brands in Kenya. BP Creatives defines voice, messaging, and identity that resonate and endure.",
  },
  {
  ...
  },
  {
    ...
    overview: [
      ...
      "We work across Instagram, LinkedIn, Facebook, X, and emerging platforms relevant to Kenyan audiences, adapting format and tone without losing who you are.",
    ],
    deliverables: [
  ...
  },
  {
    ...
    overview: [
      ...
      "Based in Nairobi, we understand local logistics, cultural nuance, and the production partners who deliver under pressure.",
    ],
    deliverables: [
  ...
  },
  {
    ...
    icon: "users",
    metaDescription:
      "Community engagement and strategic partnerships in Kenya. BP Creatives builds alliances and programmes that grow trust and reach.",
  },
  {
    ...
    process: [
      ...
      },
      {
        step: "Measure",
        description:
          "We assess sentiment recovery, lessons learned, and programme updates to strengthen future resilience.",
      },
    ],
    icon: "shield",
    metaDescription:
